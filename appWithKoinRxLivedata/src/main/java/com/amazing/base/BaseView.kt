...
import com.amazing.module.event.RxBus
import com.amazing.module.event.RxBusListener
...
abstract class BaseView<T : ViewBinding> : LinearLayout, KoinComponent, IBaseView, RxBusListener {
    ...
    private fun initEventBus() {
        if (activity == null) {
            Log.e(className, "can not listen to RxBus in $className, cause activity or LifecycleOwner not founded")
            return
        }
        RxBus.initListener(this, activity!!)
    }
