...
import com.amazing.extensions.displayInformation
import com.amazing.extensions.onClick
...
class CalendarView : BaseView<ViewCalendarBinding> {
    ...
    private lateinit var clickPublishProcessor: PublishProcessor<() -> Unit>
    ...
    override fun init() {
        ...
        clickPublishProcessor = PublishProcessor.create()
    }
    ...
    override fun initAction() {
        ...
        activity!!.addDisposable(
            clickPublishProcessor
        ...
        viewBinding.tvGoPrevious.onClick(activity!!) { viewModel.goPreviousWeek() }
        viewBinding.tvGoNext.onClick(activity!!) { viewModel.goNextWeek() }
    }
    ...
    override fun initObserver() {
        ...
        viewModel.isPreviousWeekAvailableStateLiveData.observe(activity!!) {
    ...
    override fun onTimezoneChanged() {
        ...
        initTimezone()
        // fetch calendar data again
        viewModel.retry()
    }

    override fun onNetworkAvailableChanged(isAvailable: Boolean) {
        // when network is available and current data request is error, retry automatically.
